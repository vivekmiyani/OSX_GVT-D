...
args=(
  ...
  -smp $(nproc)
  -vga none -nographic
  -device vfio-pci,host=0000:00:02.0,id=hostdev0,bus=pcie.0,addr=0x2,romfile="$REPO_PATH/$I915_OVMF_DIR/i915ovmf.rom"
  -fw_cfg name=etc/igd-opregion,file="$REPO_PATH/$I915_OVMF_DIR/opregion.bin"
  -fw_cfg name=etc/igd-bdsm-size,file="$REPO_PATH/$I915_OVMF_DIR/bdsmSize.bin"
